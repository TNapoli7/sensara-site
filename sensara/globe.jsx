          ...
          <div className="border-t border-white/[0.06] pt-12 md:pt-16">
            <div className="grid grid-cols-3 md:grid-cols-6 gap-8 md:gap-6 items-start justify-items-center">
              {[
                ...
                { id:'iso', name:'ISO 9001', sub:'Quality Management', icon: <svg viewBox="0 0 80 80" width="128" height="128" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="40" cy="40" r="32" stroke="#2E7D32" strokeWidth="4" fill="none"/><circle cx="40" cy="40" r="22" stroke="#2E7D32" strokeWidth="2" fill="none"/><text x="40" y="36" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="700" fontSize="13" fill="#2E7D32">ISO</text><text x="40" y="52" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="600" fontSize="11" fill="#2E7D32">9001</text></svg> },
                { id:'grs', name:'GRS', sub:'Global Recycled Standard', icon: <svg viewBox="0 0 80 80" width="128" height="128" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M40 12 C55 12 66 23 66 38 L58 38 L68 52 L78 38 L70 38 C70 20 57 8 40 8" fill="#0277BD"/><path d="M40 68 C25 68 14 57 14 42 L22 42 L12 28 L2 42 L10 42 C10 60 23 72 40 72" fill="#0277BD"/><text x="40" y="44" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="700" fontSize="14" fill="#0277BD">GRS</text></svg> },
                { id:'oekotex', name:'OEKO-TEX', sub:'Standard 100', icon: <svg viewBox="0 0 80 80" width="128" height="128" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M40 8 C40 8 58 20 58 42 C58 56 50 68 40 72 C30 68 22 56 22 42 C22 20 40 8 40 8Z" fill="#009688"/><text x="40" y="38" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="800" fontSize="10" fill="#fff" letterSpacing="0.5">OEKO</text><text x="40" y="50" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="800" fontSize="10" fill="#fff" letterSpacing="0.5">TEX</text><text x="40" y="60" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="400" fontSize="6" fill="#fff" opacity="0.8">®</text></svg> },
                { id:'cfp1', name:'Carbon Footprint', sub:'Product 220 gsm', icon: <svg viewBox="0 0 80 80" width="128" height="128" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="40" cy="40" r="30" stroke="#43A047" strokeWidth="3" fill="none"/><ellipse cx="40" cy="40" rx="30" ry="12" stroke="#43A047" strokeWidth="1.5" fill="none"/><ellipse cx="40" cy="40" rx="12" ry="30" stroke="#43A047" strokeWidth="1.5" fill="none"/><line x1="10" y1="40" x2="70" y2="40" stroke="#43A047" strokeWidth="1"/><line x1="40" y1="10" x2="40" y2="70" stroke="#43A047" strokeWidth="1"/><path d="M34 56 C34 56 36 48 40 48 C44 48 46 56 46 56" stroke="#43A047" strokeWidth="2.5" strokeLinecap="round" fill="none"/><path d="M36 58 C36 58 38 52 40 52 C42 52 44 58 44 58" stroke="#43A047" strokeWidth="2" strokeLinecap="round" fill="none"/></svg> },
                { id:'cfp2', name:'Carbon Footprint', sub:'Product 350 gsm', icon: <svg viewBox="0 0 80 80" width="128" height="128" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="40" cy="40" r="30" stroke="#43A047" strokeWidth="3" fill="none"/><ellipse cx="40" cy="40" rx="30" ry="12" stroke="#43A047" strokeWidth="1.5" fill="none"/><ellipse cx="40" cy="40" rx="12" ry="30" stroke="#43A047" strokeWidth="1.5" fill="none"/><line x1="10" y1="40" x2="70" y2="40" stroke="#43A047" strokeWidth="1"/><line x1="40" y1="10" x2="40" y2="70" stroke="#43A047" strokeWidth="1"/><path d="M34 56 C34 56 36 48 40 48 C44 48 46 56 46 56" stroke="#43A047" strokeWidth="2.5" strokeLinecap="round" fill="none"/><path d="M36 58 C36 58 38 52 40 52 C42 52 44 58 44 58" stroke="#43A047" strokeWidth="2" strokeLinecap="round" fill="none"/></svg> },
              ].map(cert => (
                <a key={cert.id} href="#" className="cert-item flex flex-col items-center gap-3 group cursor-pointer noselect" title={`${cert.name} - ${cert.sub}`}>
                  ...
                  <div className="text-center">
                    <span className="cert-label block mono text-[10px] tracking-[0.15em] uppercase text-white/35 transition-colors duration-500">{cert.name}</span>
                    <span className="cert-label block mono text-[8px] tracking-[0.1em] uppercase text-white/20 mt-0.5 transition-colors duration-500">{cert.sub}</span>
                  </div>
                </a>
              ))}
            </div>
